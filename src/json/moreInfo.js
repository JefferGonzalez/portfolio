      ...
      Education: [
        {
          ...
          certificate: `<a class='btn btn-primary btn-sm' href='${require("./../resources/pdf/DIPLOMA.pdf")}' download>${t(
        ...
        },
        {
          ...
          certificate: `<a class='btn btn-primary btn-sm' href='${require("./../resources/pdf/TITULO ADSI - JEFFERSON DAVID GONZALEZ CELY.pdf")}' download>${t(
            "actions.btn-download"
          )}</a>`,
        },
        {
          ...
          place:
            "<a class='text-decoration-none' href='https://www.sena.edu.co/es-co/Paginas/default.aspx' target='_blank' rel='noopener noreferrer'>SENA</a>",
          certificate: `<a class='btn btn-primary btn-sm' href='${require("./../resources/pdf/CERTIFICADO-PHOTOSHOP.pdf")}' download>${t(
            "actions.btn-download"
          )}</a>`,
        },
        {
          ...
          year: "2022",
          place:
            "<a class='text-decoration-none' href='https://www.efset.org' target='_blank' rel='noopener noreferrer'>EF SET</a>",
          certificate: `<a class='btn btn-primary btn-sm' href='https://www.efset.org/cert/3wfb66' target='_blank'>${t(
            "actions.btn-certificate"
          )}</a>`,
        },
      ],
      Experience: [
        {
          ...
          certificate: `<a class='btn btn-primary btn-sm' href='${require("./../resources/pdf/SURA-CERTIFICADO.PDF")}' download>${t(
            "actions.btn-download"
          )}</a>`,
        },
      ],
